...
layer_suffix = '_OSM_Road_202608' # ● Suffix for label each exported layer, e.g., U_TERRENO correspond to 'Urban'
index_field = 'MpCodigo' # ● Index field in the selected layer, e.g., CountyID, MpCodigo
...
load_layer_in_map = False # ● Load each exported layer into the current QGIS project map
