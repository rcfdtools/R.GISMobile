...
for i in directories:
    ...
    if i not in exclude_folder:
        ...
        readme_file.write('<div align="center"><img alt="rcfdtools" src="../../../graph/R.GISMobile.svg" width="250px"></div>\n\n')
...
geojson_file_write.write('# :earth_americas:Geographical Points of Interest - POI\n\n> A Point of Interest (POI) list is a dataset containing specific, geographically located points on a map that are considered useful or interesting, such as dams, reservoirs, ecological parks, or landmarks. Each entry in the list typically includes a name, location (latitude/longitude), and category to identify the place. [:earth_americas:Pictures Web Map](https://rcfdtools.github.io/rcfdtools/tool/poi/)\n\n### A. Map points\n\n')
