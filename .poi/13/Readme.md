...
`Picture by` rcfdtools <br>`Category` Technical field visit <br>`Location over` [Google Maps](http://maps.google.com/maps?q=9.528337,-73.507306) or [Openstreet Map](https://www.openstreetmap.org/query?lat=9.528337&lon=-73.507306) 
