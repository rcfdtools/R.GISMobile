...
`Picture by` rcfdtools `Category` Technical field visit :earth_americas:`Location over` [Google Maps](http://maps.google.com/maps?q=9.538404,-73.521755) or [Openstreet Map](https://www.openstreetmap.org/query?lat=9.538404&lon=-73.521755) 
